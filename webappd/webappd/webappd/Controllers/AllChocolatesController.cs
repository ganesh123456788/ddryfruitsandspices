...
namespace AllChocolatesController.Controllers
{
    public class ImageController : Controller
    {
        private string connectionString = ConfigurationManager.ConnectionStrings["ChocolateDBConnectionString"].ConnectionString;
        ...
        // POST: Image/Upload
        [HttpPost]
        public ActionResult Upload(Chocolates model)
        {
        ...
        private void SaveImageToDatabase(string imageName, string imagePath)
        {
            ...
            {
                string query = "INSERT INTO Chocolates (ImageName, ImagePath) VALUES (@ImageName, @ImagePath)";
